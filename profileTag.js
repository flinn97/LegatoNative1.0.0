...
render(){
  ...
  return (
    ...
    shadowRadius: 3,
      ...
      <View style={{width:'100%', display:'flex', alignItems:'center', marginTop:10}}><Text style={{color:'blue'}}>Currently viewing as </Text></View>
      <View style={{display:'flex', flexDirection:'row', justifyContent:'center', width:'100%', marginTop:10}}>
        <Image source={this.state.pic?this.state.pic: currentstudent.getJson().picURL } style={{width:50, height:50, borderRadius:100}}/>
