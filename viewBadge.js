...
render(){
 ...
 <View style={{width:'90%', height:'85%', marginTop:20, backgroundColor:"white", zIndex:1002, display:'flex', alignItems:'center'}}>
  <Image source={badge} style={{width:75, height:75}}/>
  <Text>{state.currentBadge.getJson().title}</Text>
  <Text>{state.currentBadge.getJson().description}</Text>
